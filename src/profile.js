...
const ProfilePage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h3 style={{ fontSize: "20px", marginBottom: "20px" }}>Study Tasks</h3>
            ...
            >
              ...
              <select
                ...
                style={{
                  ...
                  borderRadius: "5px",
                  border: "1px solid #ccc",
                  backgroundColor: checkedItems[index] ? "#e0e0e0" : "white", // Grey out when disabled
                  cursor: checkedItems[index] ? "not-allowed" : "pointer",
                  marginRight: "10px",
                }}
              >
